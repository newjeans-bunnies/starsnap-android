                ...
                item {
                    SettingSection(title = "계정") {
                        if (showUserDataSkeleton) {
                            SettingRowSkeleton(
                                modifier = Modifier.loadingSemantics("계정 정보"),
                            )
                            SettingDivider()
                            SettingRowSkeleton()
                        } else if (userDataUnavailable) {
                            SettingInfoBanner(
                                text = "계정 정보를 불러오면 프로필과 이메일을 확인할 수 있어요.",
            ...
            SettingCategory.Privacy -> {
                item {
                    SettingSection(title = "공개 범위") {
                        if (showUserDataSkeleton) {
                            SettingSwitchRowSkeleton(
                                modifier = Modifier.loadingSemantics("공개 범위"),
                            )
                        } else if (userDataUnavailable) {
                            SettingInfoBanner(
                                text = "계정 정보를 불러오면 공개 범위를 설정할 수 있어요.",
                                modifier = Modifier.padding(16.dp),
                            )
                        } else {
                            SettingSwitchRow(
